...
function FrontPage_Location(props) {
  const Deliver_Button_Color_front_page_var=localStorage.getItem('Deliver_Button_Color_front_page');
  const text_color_front_page_var=localStorage.getItem('text_color_front_page');
  const Take_Away_Button_Color_front_page_var=localStorage.getItem('Take_Away_Button_Color_front_page');
  const Dinning_Button_Color_front_page_var=localStorage.getItem('Dinning_Button_Color_front_page');
  const Use_Location_Button_Color_front_page_var=localStorage.getItem('Use_Location_Button_Color_front_page');
  const Select_Button_Color_front_page_var=localStorage.getItem('Select_Button_Color_front_page');
  const Border_Radius_front_page_var=localStorage.getItem('Border_Radius_front_page');
  const Border_color_front_page_var=localStorage.getItem('Border_color_front_page');
  const background_color_front_page_var=localStorage.getItem('background_color_front_page');
